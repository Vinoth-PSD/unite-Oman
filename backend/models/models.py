...
class Business(Base):
    ...
    status            = Column(SAEnum(BusinessStatus), default=BusinessStatus.pending, index=True)
    plan              = Column(SAEnum(PlanType), default=PlanType.basic, index=True)
    listing_type      = Column(SAEnum(ListingType), default=ListingType.standard, index=True)
